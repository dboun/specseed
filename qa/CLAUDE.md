...
Default QA runner config: Codex with `gpt-5.4-mini` for every runner function, unless user asks otherwise. Default tracker: local UI backed by runtime `remote_local` behavior, not GitHub/GitLab.
