...
# Tasks carry entity context in their payload; entities live one dir over.
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "entities"))

from entity_base import Entity, EntityRef  # noqa: E402
